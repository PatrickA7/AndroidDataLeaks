...
class New_Toplevel:
    def __init__(self, top=None):
        ...
        self.Message6.configure(text='''Mobile Malware Analysis''')
        ...
        self.Button1_2.configure(command=lambda: webbrowser.open('http://www.mobilemalware.com.br/analysis/index_en.php'))
